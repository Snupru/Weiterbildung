...
if(english1.indexOf('Paul') !== -1){
  english1.push('Monika')
}

if(english2.indexOf('Paul') !== -1){
...
let index = english1.indexOf('Günther');
console.log(english1.indexOf('Günther'));
if(index !== -1){
  english1.splice(index, 1);
}

index = english2.indexOf('Günther');
if(index !== -1){
  english2.splice(index, 1);
}
