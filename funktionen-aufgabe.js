...
function translateWord(word) {
  let pos = LANGUAGE_DE.indexOf(word.toLowerCase());
  if(pos === -1)
    return word;
  
  return LANGUAGE_EN[pos];
}

console.log(translateWord('Sprachkurs'));
console.log(translateWord('Katze'));
...
function translateSentence(sentence) {
  ...
  return ucFirst(translatedWords.join(" "));
}
