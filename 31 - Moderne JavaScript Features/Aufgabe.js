...
makeTransfer2("DE12345", "", "Max Mustermann")
...
function makeTransfer3({iban, bic = "", accountHolder}) {
...
function makeTransfer4(kto) {
  // Kommentiere diesen Code zum Testen ein:
  console.log("makeTransfer4, iban: ", kto.iban)
  console.log("makeTransfer4, bic: ", kto.bic ? kto.bic : "");
  console.log("makeTransfer4, accountHolder: ", kto.accountHolder)
}
