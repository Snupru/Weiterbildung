...
console.log("products:", products.map((item) => { return {...item, kcal: 9 * item.fat + 4 * item.carbs + 4 * item.protein }}));
...
console.log("Produkt mit mehr als 50g:", products.some(item => item.fat > 50));

// 1c) Kannst du 1b) auch mit einem .reduce() lösen? Wenn ja, wie?

const exists2 = products.reduce((prev, cur) => {return prev ? true : cur.fat > 50;}, false);
console.log("Produkt mit mehr als 50g:", exists2);
